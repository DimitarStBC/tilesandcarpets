      ...
      <div class="FAQ">
        ...
        <div id="question-2" class="FAQq" v-on:click="Expand02()">
          ...
          <div>
            ...
            <p
              id="question2More"
            >Дамаската попива в себе си миризми, задържа косми, хранителни отпадъци и акари. За да запазите материята си чиста и "жива" по-дълго време, използвайте услугата ни за пране поне три пъти в годината. Процесът не нарушава целостта и цвета.</p>
          </div>
        </div>
      </div>
    </div>
